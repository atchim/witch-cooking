...
\begin{document}
  ...
  irônico slogan \textit{\textbf{``any color you like''}} faz alusão à famosa frase
  \textit
  ...
  específicos, como ``.vhs'' e ``.rasi'' --, os quais têm parsers gerados pelo
  \textit{Tree-Sitter} e são suportados pelo sistema.
  ...
  \begin{inparaenum}
    ...
    \item cada um com suas próprias configurações e níveis de suporte para
          esses estilos. Por outro lado, os estilos não-convencionais
    \item exigiam inevitavelmente uma aplicação manual, o que consumia
          considerável tempo e esforço.
  \end{inparaenum}
  ...
  \end{inparaenum}
  o \textit{Witch Cooking} foi desenvolvido como uma ferramenta de linha de
  comando, de natureza prototípica, para a formatação de código-fonte.
