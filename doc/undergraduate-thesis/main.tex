...
\begin{document}
  ...
  \begin{inparaenum}
    ...
    \item seu ecossistema de desenvolvimento fértil, que oferece
          \begin{inparaenum}
            ...
            \item \textit{Rust Analyzer}, uma implementação do
                  \textit{Language Server Protocol} (LSP) para a linguagem,
                  etc.
          \end{inparaenum}
  \end{inparaenum}
  ...
  Como mencionado na \cref{section:motivations}, o \witchcooking formata o
