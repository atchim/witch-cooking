...
\begin{document}
  ...
  linguagens de programação --- e.g., \textit{Black} \cite{black-2023-black} e
  \textit{rfmt} \cite{yelland-2015-rfmt}. Além disso, essas ferramentas
  costumam oferecer uma quantidade limitada de configurações de estilização,
  dificultando a personalização pelo usuário. Isso é especialmente agravado em
  formatadores opinativos, onde um estilo é rigorosamente imposto.
