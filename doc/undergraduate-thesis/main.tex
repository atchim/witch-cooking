...
\lstset{basicstyle = {\small\ttfamily}, frame = single, tabsize = 2}
...
\begin{document}
  ...
  \begin{KeepFromToc}\lstlistoflistings\end{KeepFromToc}
  \cleardoublepage
  ...
  \begin{lstlisting}[language = C, caption = Foo bar, gobble = 4]
    // aisuhdaius
    int foo(x) {
      return x + 1;
    }
