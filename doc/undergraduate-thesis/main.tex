...
\begin{document}
  ...
  continua a ser diretamente influenciado por esse parâmetro.

  Apesar da importância que o \textit{CPL} normalmente desempenha na
  formatação, o \witchcooking atualmente não fornece algum mecanismo de
  formatação conforme esse aspecto. Mais precisamente, a ferramenta carece de
  mecanismos que proporcionem formatação condicionada, em geral.
