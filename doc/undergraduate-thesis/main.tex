...
\begin{document}
  ...
  \newlength{\halfpart}
  \newlength{\biggerpart}
  \newlength{\smallerpart}

  \setlength{\biggerpart}{.5\textwidth}
  \setlength{\halfpart}{.5\textwidth - .5em}
  \setlength{\smallerpart}{.5\textwidth - 1em}
  ...
  \cref{snippet:scheme:rust:vec-items-sep}. Ao formatar o vetor com essa consulta, é
