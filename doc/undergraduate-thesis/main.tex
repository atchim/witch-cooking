...
\begin{document}
  ...
  \begin{inparaenum}
    ...
    \item objeto%
          ...
          Além disso,
    \item é instanciada uma estrutura editora que contém o
          \begin{inparaenum}
      ...
      { \begin{tikzpicture}[node distance=1em]
          \node (init) {
            \begin{tikzpicture}[nodes=draw]
              \node (I) {Analisa a árvore de sintaxe};
          ...
          \node (init-label) [left=of init] {Inicialização};
          \draw
            [decorate,decoration=zigzag]
            let
              \p1=(init-label.south west),\p2=(init.south east)
              in
              (\x1,\y2-1em) -- (\x2,\y2-1em);
        \end{tikzpicture}}
    \vspace{-2ex}
