...
\begin{document}
  ...
  \begin{inparaenum}
    ...
    \item uso de \textit{\gloss{wildcard}s}; e a
  ...
  \cref{snippet:param-query-c}. O
  \begin{inparaenum}
    \item nó \textit{identifier} é capturado com o nome \textit{id}, como
          ...
          \codesnippetinline
            ...
            [escapeinside=||]%
          . Além disso, o
    \item predicado \textit{eq?} é aplicado para garantir que o conteúdo da
  ...
  A operação do algoritmo de formatação divide-se em três etapas, que são a
  \begin{inparaenum}
    \item inicialização, a
    \item iteração das correspondências dos padrões, e o
  ...
  \begin{inparaenum}
    ...
    \item objeto%
          ...
          Além disso, uma
    \item estrutura editora é instanciada, que contém o
          \begin{inparaenum}
            \item texto do código-fonte em edição -- originado do código
                  submetido pelo usuário --, juntamente com um
            \item vetor de edições.
          \end{inparaenum}
          Essa estrutura é utilizada pelos predicados para realizar as edições
          no código e armazená-las. Na sequência,
    \item é inicializado um objeto de configurações, que é futuramente
          ...
          Finalizando a etapa de inicialização, a
    \item estrutura de correspondências é derivada do
          \begin{inparaenum}
            \item objeto de consulta, juntamente com a
            \item árvore analisada e o
            \item texto do código-fonte submetido.
          \end{inparaenum}
  \end{inparaenum}
