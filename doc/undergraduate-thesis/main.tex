...
\begin{document}
  ...
  \begin{inparaenum}
    ...
    \item seu ecossistema de desenvolvimento fértil, que oferece
          \begin{inparaenum}
            ...
            \item \textit{Cargo}, o gerenciador de pacotes,
  ...
  \begin{inparaenum}
    ...
    \item possuir uma linguagem de consulta versátil e extensível que, dentre
          ...
          \end{inparaenum}
  \end{inparaenum}
  Embora essa biblioteca não tenha sido originalmente projetada para formatação
  de código-fonte, o autor deste trabalho reconheceu o potencial do
  \treesitter, mais precisamente, o potencial de sua linguagem de consulta, que
  -- como já ressaltado -- é extensível. Assim, para realizar a formatação, o
  \witchcooking baseou-se na extensão e disponibilização de predicados
  designados a executar operações específicas de formatação.
