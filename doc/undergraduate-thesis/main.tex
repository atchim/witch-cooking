...
\hypersetup
  { pdftitle       = {\@title},
    pdfauthor      = {\@author},
    pdfsubject     = { \textit{Witch Cooking}: Formatação de Código via
                       Linguagem de Consulta do \textit{Tree-Sitter}},
...
\begin{document}
  ...
  \section{A História da Evolução dos Algoritmos de Formatação de Código-Fonte}
