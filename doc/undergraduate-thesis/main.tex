...
\begin{document}
  ...
  \begin{apendicesenv}
    ...
    observa-se que o código de execução 0 foi retornado, ou seja, a execução
    foi um sucesso. Isso implica que todas as asserções feitas no código eram
    verdadeiras. Por sua vez, as asserções feitas nos
    \cref
      {%
        snippet:rust:ts-node-edit-demo-part-6,%
        snippet:rust:ts-node-edit-demo-part-7}
    provaram que, com base na edição do
