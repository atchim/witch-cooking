...
\begin{document}
  ...
  \end{inparaenum}
  o \textit{Witch Cooking} foi desenvolvido como uma software de linha de
  ...
  \boxed{\texttt{[\textit{SRC}]}} é omitido, o código-fonte a ser formatado
  deve ser provido via \textit{\gloss{pipeline}}, e a sua linguagem deve
  ser explicitada via \boxed{\texttt{[\textbf{-l} \textit{LANG}]}}.
