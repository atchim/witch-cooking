...
\begin{document}
  ...
  No desenvolvimento deste trabalho, foram utilizados diferentes procedimentos,
  incluindo
  \begin{inparaenum}
    ...
    \item estudo de caso, com as respectivas finalidades de
          \begin{inparaenum}
            \item entender como o \treesitter e sua linguagem de consulta
                  poderiam permitir a formatação de código-fonte, além de
  ...
  O algoritmo opera da seguinte maneira. Primeiramente, a
  \begin{inparaenum}
    \item árvore de sintaxe -- derivada do código-fonte submetido para
          formatação -- é analisada. Em seguida, um
    \item objeto de consulta é gerado a partir do arquivo contendo as
          ...
          \begin{inparaenum}
            ...
            \item é posteriormente utilizado para obter as correspondências
                  dos seus padrões. Além disso, um
          \end{inparaenum}
    \item objeto editor é instanciado, que contém o
          \begin{inparaenum}
            \item texto do código-fonte em edição -- originado do código
                  submetido pelo usuário --, juntamente com um
            \item vetor de edições.
          \end{inparaenum}
          Esse objeto é utilizado pelos predicados para realizar as edições no
          código e armazená-las.
  \end{inparaenum}
