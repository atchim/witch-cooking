...
\begin{document}
  ...
  específicos, como ``.vhs''' e ``.rasi''' --, os quais têm parsers gerados
  pelo \treesitter e, consequentemente, são suportados pelo sistema.
