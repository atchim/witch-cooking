...
\begin{document}
  ...
  parâmetro \textit{x} é definido em ambos os códigos, são necessárias
  consultas distintas, apresentadas pelos
  \cref{snippet:add-two-query-c,snippet:add-two-query-rust}, respectivamente.
