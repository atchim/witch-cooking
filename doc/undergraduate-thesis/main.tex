...
\usepackage{csquotes}
\usepackage[backend = biber, style = abnt, pretty]{biblatex}
\usepackage{paralist}
...
\hypersetup
  { pdftitle       = {\@title},
    pdfauthor      = {\@author},
    pdfsubject     = {Witch Cooking: Formatação de Código via Linguagem de
                      Consulta do Tree-Sitter},
...
\begin{document}
  ...
  A formatação do código pode ser realizada manualmente pelo programador,
  ...
  que automatizam a formatação do código, é também comum a utilização do
  ...
  \apud{harris-1956-keyboard}[1]{yelland-2015-rfmt}. Esses métodos se
  popularizaram como \textit{\gloss{prettyprinting}}, termo que se refere à
