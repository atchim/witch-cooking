...
\begin{document}
  ...
  \begin{apendicesenv}
    ...
    para confirmar que a extensão desse nó refletiu essa edição. Já no
    \cref{snippet:rust:ts-node-edit-demo-part-7}, os mesmos procedimentos do
    trecho anterior são repetidos, com exceção de que:
    \begin{inparaenum}
