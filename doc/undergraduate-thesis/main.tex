...
\begin{document}
  ...
  --- funções geradoras para descrever \textit{layouts} alternativos de
  código-fonte --- presentes em seu formatador de código-fonte para a
  linguagem R. Mais precisamente:
  \begin{inparaenum}
