...
\begin{document}
  ...
  implementava o algoritmo \textit{recursive re-predictor}, que percorria as
  árvores de nós representando as listas e imprimia os nós considerando
  seus tamanhos e a quantidade máxima de caracteres que ainda poderiam ser
  inseridos em uma linha \cite{goldstein-1973-pretty}.

  No artigo \textit{A one-pass prettyprinter}, \textcite{hearn-1979-one}
  propuseram um algoritmo mais elaborado para \textit{prettyprinting} que
  utilizava um par de corrotinas%
  \footnote
