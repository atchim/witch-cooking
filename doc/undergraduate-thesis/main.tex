...
\titulo
  {%
    \witchcooking: Formatação Personalizada de Código-Fonte via a Linguagem de
...
\begin{document}
  ...
  \begin{resumo}
    ...
    prototípico de linha de comando, fundamentado no sistema \treesitter, que
    tem como objetivos:
    \begin{inparaenum}
  ...
  \begin{resumo}[Abstract]
    \begin{otherlanguage*}{english}
      ...
      terms of supported languages, configuration options, and the ability to
      define custom formatting styles. To overcome or reduce the limitations
      frequently encountered in conventional formatting tools, this work
      introduces \witchcooking, a command-line prototypical software built on
      the \treesitter system. It aims to:
      \begin{inparaenum}
      ...
      from an unawareness of a \treesitter system peculiarity --- limits the
      use of \witchcooking:
      \begin{inparaenum}
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%% Driving the Formatting %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%

  \section{Dirigindo a Formatação}
  \label{section:driving}
  ...
  do predicado \codesnippetinline{indent!}, foram discutidos:
  \begin{inparaenum}
  ...
  \begin{inparaenum}
    ...
    \item das configurações de estilização para o predicado
          \codesnippetinline{set!}, descritas na \cref{section:driving}, sendo
          elas
          \begin{inparaenum}
            \item \codesnippetinline{indent-rule} e
            \item \codesnippetinline{indent-style};
    ...
    \item dos predicados basais para a formatação, estendendo a linguagem de
          consulta, demonstrados também na \cref{section:driving}, sendo eles
          \begin{inparaenum}
            \item \codesnippetinline{space!},
            \item \codesnippetinline{indent!}, e
            \item \codesnippetinline{indent-offset!};
  ...
  \begin{inparaenum}
    \item O problema mais premente é a sincronização de nós --- abordado na
          \cref{section:limitations} ---, para o qual seria possível
          desenvolver um algoritmo dedicado capaz de sincronizar corretamente
          qualquer nó mesmo após ele ter sofrido edições tangentes à sua
          extensão.

          Outras melhorias potenciais, também discutidas na
          \cref{section:limitations}, estão relacionadas ao funcionamento do
