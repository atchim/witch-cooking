...
\begin{document}
  ...
  escrito na linguagem de programação Rust \cite{rust-2023-rust}, e de natureza
  prototípica -- para a formatação de código-fonte. A ferramenta elaborada tem
  como objetivos
  \begin{inparaenum}
  ...
  funcionamento. Portanto, nesta seção, será abordado o funcionamento da
  linguagem de consulta do \treesitter, permitindo assim uma melhor compreensão
  da base em que o \witchcooking foi desenvolvido.

  Como abordado no \cref{chapter:tree-sitter}, essa linguagem foi
  ...
  No trecho de código acima, é possível notar algumas diferenças em relação à
  sua versão original, que foi apresentada no \cref{snippet:param-query-c}.
  \begin{inparaenum}
