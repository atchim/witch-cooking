...
\begin{document}
  ...
  \begin{inparaenum}
    \item a indentação não está correta. Isso ocorre devido ao
          fato de que a expressão de função \codesnippetinline[rust]{baz()}
          possui o mesmo nível de indentação que a declaração de função
